...
export default function GroupCardSkeleton() {
  return (
    <article
      ...
      className="relative flex h-[346px] w-full max-w-[460px] animate-pulse flex-col overflow-hidden rounded-xl bg-white shadow-md sm:h-[219px] sm:max-w-full sm:flex-row sm:rounded-2xl sm:p-6">
